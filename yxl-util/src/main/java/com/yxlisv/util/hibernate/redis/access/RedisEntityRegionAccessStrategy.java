...
public class RedisEntityRegionAccessStrategy implements EntityRegionAccessStrategy {
	 ...
	 * @version 1.0
	 */
	public RedisEntityRegionAccessStrategy(AccessType accessType, EntityRegion entityRegion) {
	...
	public Object get(SessionImplementor session, Object key, long txTimestamp) throws CacheException {
		logger.debug("Redis get entry [key="+ key +"]");
	...
	public boolean putFromLoad(SessionImplementor session, Object key, Object value, long txTimestamp, Object version, boolean minimalPutOverride) throws CacheException {
		logger.debug("Redis put entry [key="+ key +", value="+ value +"]");
	...
	public void remove(SessionImplementor session, Object key) throws CacheException {
		logger.debug("Redis delete entry [key="+ key +"]");
		JedisUtil.delete(KeyUtil.formatKey(key));
	}

	@Override
	public void removeAll() throws CacheException {
		logger.debug("Redis set entry removeAll");
	...
	public void evictAll() throws CacheException {
		logger.debug("Redis set entry evictAll");
		JedisUtil.delete(KeyUtil.keyPrefix + "*");
	}
