...
public class DataSourceFactory {
	...
	public static DataSource createC3P0(DataSourceBean dataSourceBean) {
		...
		logger.info("create a c3p0 datasource [dbType: "+ dataSourceBean.getDbType() +", jdbcUrl: "+ dataSourceBean.getJdbcUrl() +", username: "+ dataSourceBean.getUsername() +", password: "+ dataSourceBean.getPassword() +"]");
